...
class Tab(models.Model):
	...
	content=UEditorField(u'内容	',height=500,width=500,default='test',imagePath="uploadimg/",imageManagerPath="imglib",toolbars='biglarge1',options={"elementPathEnabled":True},filePath='upload',blank=True)
